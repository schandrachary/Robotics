...
int main(int argc, char** argv)
{
	...
	// Create a publisher that can publis a std_msgs::Float64 message on the 
	...
	ros::Publisher joint2_pub = n.advertise<std_msgs::Float64>("/simple_arm/joint_2_positioin_controller/command", 10);

	// Set the loop frequency of 10Hz
	ros::Rate loop_rate(10);

	int start_time, elapsed = 0;
